    ...
    public class SeedBookAuthors : IEntityTypeConfiguration<BookAuthor>
    {
        public void Configure(EntityTypeBuilder<BookAuthor> builder)
        {
            builder.HasData(
              ...
              new BookAuthor { BookId = 2, AuthorId = 20 }, // this Author has written from 2 Books many-to-many
              ...
              new BookAuthor { BookId = 10, AuthorId = 20 }, // this Author has written from 2 Books many-to-many
              ...
              new BookAuthor { BookId = 28, AuthorId = 4 },  // this book has been written from 2 Authors
              new BookAuthor { BookId = 28, AuthorId = 26 }, // this book has been written from 2 Authors
